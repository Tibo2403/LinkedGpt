          ...
          <div className="flex items-center">
            ...
            {user && (
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                <a href="#dashboard" className="border-[#0A66C2] text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                ...
                <a href="#messages" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                  <MessageSquare className="h-4 w-4 mr-2" />
                  Send Messages
                </a>
                <a href="#received-messages" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                ...
                <a href="#cv-generator" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
